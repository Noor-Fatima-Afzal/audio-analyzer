...
export default function SimulatedWaveform() {
  ...
  return  <svg class="audiogram col" xmlns="http://www.w3.org/2000/svg" height="200">
  <defs>
    <linearGradient id="audiogram-background" x1="0.5" y1="0" x2="0.5" y2="1">
      <stop offset="0%" stop-color="#00e5d1" />
      <stop offset="31.33%" stop-color="#13c3d2" />
      <stop offset="94%" stop-color="#2577f9" />
    </linearGradient>
  </defs>
